...
| [Speedtest by Ookla](https://www.speedtest.net/) | Utilities | Tests internet connection speed (download, upload, ping), no signup required.                            |
| [goQR.me](https://goqr.me/)                      | Utilities | Generates QR codes in PNG, EPS, and SVG, no signup required.                                             |
| [RANDOM.ORG](https://www.random.org/)            | Utilities | True random number, sequence, and password generator, no signup required for the free tools.             |
...
| [Can I Use](https://caniuse.com/)           | DevTools | Browser support tables for HTML5, CSS3, and other web technologies, no signup required.                    |
...
| [Google Fonts](https://fonts.google.com/) | Design   | Browse and download open-source fonts, no signup required.                                                                        |
| [Unsplash](https://unsplash.com/)         | Design   | Browse and download free high-resolution stock photos, no signup required.                                                        |
...
| [VirusTotal](https://www.virustotal.com/)                                 | Privacy  | Scans a file or URL against dozens of antivirus engines, no signup required for a basic scan.               |
| [Cover Your Tracks](https://coveryourtracks.eff.org/)                     | Privacy  | Tests how well your browser is protected from tracking and fingerprinting, no signup, a project of the EFF. |
...
| [PDF24 Tools](https://tools.pdf24.org/en/) | Converters | Merges, splits, compresses, and converts PDFs, no signup required (files are processed on PDF24's servers and deleted shortly after).    |
...
| [DeepL Translate](https://www.deepl.com/translator) | Text & Writing | Machine translation across 30+ languages, no signup required for the web translator.                             |
| [Google Translate](https://translate.google.com/)   | Text & Writing | Machine translation across 100+ languages, no signup required.                                                   |
